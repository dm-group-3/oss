...
***※리처드 스톨만이 오픈소스를 거부하면서 그의 자유 소프트웨어와 오픈소스 운동은 비슷하지만 조금 다르게 해석해야한다. 소스코드 공개와 공유의 가치라는 측면에서는 유사한 반면, 자유 소프트웨어는 GPL 라이선스 기반의 훨씬 강력하고 엄격한 소스 공개, 공유 원칙 등을 적용하고 있다.***
